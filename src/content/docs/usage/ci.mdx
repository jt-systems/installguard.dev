...
import { joinTerminalLines, prompt } from "../../../components/terminalAnsi";

export const synopsisBody = joinTerminalLines([
  prompt("installguard ci [--summary-file summary.json] [--max-warn N]"),
]);

<DocTerminal title="CI · installguard ci" body={synopsisBody} />
