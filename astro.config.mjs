      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Nightly drift rescan", slug: "recipes/nightly-drift" },
            { label: "Air-gapped promotion", slug: "recipes/air-gapped-promotion" },
            { label: "Signed attestation", slug: "recipes/signed-attestation" },
            { label: "SBOM + VEX release bundle", slug: "recipes/release-evidence" },
            { label: "Polyglot monorepos", slug: "recipes/polyglot-monorepos" },
